...
- A scheduled engine with per-institution locking, leases, work classes, daily budgets per institution and platform-wide, a shared conditional fetch cache, adaptive intervals, lead expiry and hop limits, yield-based priority and gap-targeted search.

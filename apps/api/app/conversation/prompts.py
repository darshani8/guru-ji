"""Prompts for Agent Saffron's own voice: the persona, conversation, and answers from web results.
...
def persona(language: DetectedLanguage, *, channel: str, institution: str | None, can_search: bool, now: datetime | None = None) -> str:
    ...
    return (
        "You are Agent Saffron, a warm, respectful and helpful voice assistant for an Indian educational institution"
...
def conversation_prompt(
    ...
    return (
        ...
        "Reply to the message as Agent Saffron, continuing the conversation naturally. Return only the reply."
    )
